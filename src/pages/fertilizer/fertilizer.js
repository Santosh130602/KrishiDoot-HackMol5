            ...
            <div className="flex flex-row space-x-3 my-10">
              ...
              <div className="ml-16">
                <button
                  onClick={() => setLang("hi")}
                  type="button"
                  className="inline-block px-6 py-2.5 bg-[#213c96] text-white 
            ...
            <div className="grid place-items-center mt-14 ">
              <div className="mt-2">
                <button
                  ...
                  type="button"
                  className="inline-block  px-6 py-2.5 bg-[#213c96] text-white font-medium text-xs 
...
//     axios.post("http://localhost:5000/predictFertilizer", data)
//       .then(response => {
...
//   return (
//     <>
//       {/* Your JSX for input fields and button */}
//       <button onClick={onSearchSubmit}>Predict Fertilizer</button>
